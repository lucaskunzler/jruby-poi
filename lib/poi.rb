...
require File.join(JRUBY_POI_LIB_PATH, 'poi-jars', 'poi-3.17.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-jars', 'poi-ooxml-3.17.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-jars', 'poi-ooxml-schemas-3.17.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-jars', 'poi-scratchpad-3.17.jar')
